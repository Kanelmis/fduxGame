...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?php bloginfo('template_url'); ?>/css/swiper-bundle.min.css">
  ...
  <script src="<?php bloginfo('template_url'); ?>./js/swiper-bundle.js"></script>
...
<body>
  ...
  <div class="mainHeader layoutHeader">
    <div class="headerUser"><a class="headerUserButton" id="userLogin" href="javascript:void(0);">登录</a><a
        class="headerUserButton" id="userCenter" href="https://ak.hypergryph.com/user" target="_blank">个人中心</a><span
        class="sep">|</span><a class="headerUserButton" id="userRegister" href="https://ak.hypergryph.com/user"
        target="_blank">注册</a><a class="headerUserButton" id="userLogout" href="javascript:void(0);">登出</a></div>
    ...
    <div class="sections">
      <div class="section section-1">
        ...
        <div class="ReservationWrapper">
          <button class="reserve" style="vertical-align:middle" onclick="popReserve()"><span>立即预约</span></button>
        </div>
        ...
        <form role="form" id="reserve_form" class="reservePop" action="#" method="POST">
          ...
          <div id="checkType">
            <input type="checkbox" id="post_ios" name="ios" value="ios" checked="true" onclick="checkBox(this.value)">
            <label for="ios">IOS</label>
            <input type="checkbox" id="post_android" name="android" value="android" onclick="checkBox(this.value)">
          ...
          <div class="inputWrapper">
            ...
            <div class="validation">
              ...
              <button type="button" id="sendValidation" onclick="alert('大胸好女人真希波, 今天也很可爱哦(*^_^*)')">获取验证码</button>
            </div>
          </div>
      ...
      <div class="section section-2">
        <div class="swiper-container withThumbs">
          <div class="swiper-container gallery-top">
            <div class="swiper-wrapper">
              <div class="swiper-slide"
                style="background-image:linear-gradient( rgba(37, 32, 32, 0.5), rgba(0, 0, 0, 0.5) ), url(<?php bloginfo('template_url');?>./images/bg/0.png)">
              </div>
              <div class="swiper-slide"
                style="background-image:linear-gradient( rgba(37, 32, 32, 0.5), rgba(0, 0, 0, 0.5) ), url(<?php bloginfo('template_url');?>./images/bg/1.png)">
              </div>
              <div class="swiper-slide"
                style="background-image:linear-gradient( rgba(37, 32, 32, 0.5), rgba(0, 0, 0, 0.5) ), url(<?php bloginfo('template_url');?>./images/bg/2.png)">
              </div>
              <div class="swiper-slide"
                style="background-image:linear-gradient( rgba(37, 32, 32, 0.5), rgba(0, 0, 0, 0.5) ), url(<?php bloginfo('template_url');?>./images/bg/3.png)">
              </div>
              <div class="swiper-slide"
                style="background-image:linear-gradient( rgba(37, 32, 32, 0.5), rgba(0, 0, 0, 0.5) ), url(<?php bloginfo('template_url');?>./images/bg/4.png)">
              </div>
          ...
          <div class="swiper-container gallery-thumbs">
            <div class="swiper-wrapper">
              <div class="swiper-slide"
                style="background-image: url(<?php bloginfo('template_url');?>./images/bg/0.png)">
              </div>
              <div class="swiper-slide"
                style="background-image: url(<?php bloginfo('template_url');?>./images/bg/1.png)">
              </div>
              <div class="swiper-slide"
                style="background-image: url(<?php bloginfo('template_url');?>./images/bg/2.png)">
              </div>
              <div class="swiper-slide"
                style="background-image: url(<?php bloginfo('template_url');?>./images/bg/3.png)">
              </div>
              <div class="swiper-slide"
                style="background-image: url(<?php bloginfo('template_url');?>./images/bg/4.png)">
              </div>
      ...
      <script>
        var galleryThumbs = new Swiper('.section-2 .gallery-thumbs', {
        ...
        var galleryTop = new Swiper('.section-2 .gallery-top', {
          speed: 2000,
          spaceBetween: 30,
          effect: "fade",
          loop: true,
      ...
      <div class="section section-3" id="section-worldview">
        <!--情报页-->
        <!--依照相同的模板添加新的块-->
        <div class="swiper-container">
          <div class="swiper-wrapper">
              ...
              <div class="character_display">
                ...
                <div class="char_infor">
                  ...
                  <div class="char_name">
                    ...
                    <audio id="voice_miku">
                      <source src="<?php bloginfo('template_url');?>./audios/char/miku.mp3" type="audio/mpeg" />
            ...
            <div class="swiper-slide"
              style="background-image:linear-gradient( rgba(37, 32, 32, 0.5), rgba(0, 0, 0, 0.5) ), url(<?php bloginfo('template_url');?>./images/bg/2.png)">
              <div class="character_display swiper-slide">
                <div class="intro">
            ...
            <div class="swiper-slide" style="background-image:url(<?php bloginfo('template_url');?>./images/bg/1.png)">
            </div>
            <div class="swiper-slide" style="background-image:url(<?php bloginfo('template_url');?>./images/bg/1.png)">
            </div>
          </div>
        ...
        <!-- Initialize Swiper -->
        <script>
          var swiper = new Swiper('.section-3 .swiper-container', {
            navigation: {
      ...
      <!--end of section 3-->
      <div class="section section-4" id="section-information">
        <div class="sectionDisplay">
          ...
          <div class="swiper-container">
            <div class="swiper-wrapper">
              <div class="swiper-slide"
                style="background-image:url(<?php bloginfo('template_url');?>./images/bg/0.png)"></div>
              <div class="swiper-slide"
                style="background-image:url(<?php bloginfo('template_url');?>./images/bg/1.png)"></div>
              <div class="swiper-slide"
                style="background-image:url(<?php bloginfo('template_url');?>./images/bg/10.png)"></div>
              <div class="swiper-slide"
                style="background-image:url(<?php bloginfo('template_url');?>./images/bg/7.png)"></div>
              <div class="swiper-slide"
                style="background-image:url(<?php bloginfo('template_url');?>./images/bg/9.png)"></div>
            </div>
          </div>
          <script>
            ...
            <div class="articleListWrapper">
              <ol class="articleList" data-category-key="LATEST">
                <li class="articleItem display"><a class="articleItemLink" href="/news/2021089306.html"
                    ...
                    <h1 class="articleItemTitle">厨房年终总结大会，杯子首先发言：“这一年，我就是一个杯具。”</h1>
                  </a></li>
                ...
                <li class="articleItem display"><a class="articleItemLink" href="/news/2021079395.html"
                    target="_blank"><span class="articleItemDate">2021-07-30</span><span
                      class="articleItemCate">公告</span>
                    <h1 class="articleItemTitle">坏事要在什么时候做才行? </h1>
                  </a></li>
              </ol>
      ...
      <!--footer page -->
      <div class="section section-5" id="section-footer">
        <div class="sectionDisplay">
          <div class="aboveFooter">
            ...
            <div class="shareWrapper">
              ...
              <ul class="shareLinks">
                <li>
                  <div id="wechat" onclick="jumpTo(this)" class="shareLinks-items"
                    style="background-image:url(<?php bloginfo('template_url');?>./images/wechat.png)">

                  </div>
                </li>
                <li>
                  <div id="qq" onclick="jumpTo(this)" class="shareLinks-items"
                    style="background-image:url(<?php bloginfo('template_url');?>./images/qq.png)">
                  </div>
                </li>
                <li>
                  <div id="ins" onclick="jumpTo(this)" class="shareLinks-items"
                    style="background-image:url(<?php bloginfo('template_url');?>./images/ins.png)">
                  </div>
                </li>
          ...
          <div class="footer">
            ...
            <div class="terms">
              ...
              <div class="copyright">
              <span><br>Copyright © 2020 miHoYo All Rights Reserved</span>
          </div>
          <div class="warning">
            <span style="font-size:14px;"><br>本遊戲為免費使用，遊戲內另提供購買虛擬貨幣、物品等付費服務。<br>請注意遊戲時間，避免沉迷。本遊戲部份情節涉及性、暴力 。</span>
          </div>
